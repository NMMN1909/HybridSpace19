...
public class TranslateToCube1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        addedEul = new Vector3(
           Mathf.LerpAngle(addedEul.x, ((useRAWData == true ? fTInput.RawY : -fTInput.Pitch * 2f) / 500f) * rotationScale, rotationLerpRate * Time.deltaTime),
           Mathf.LerpAngle(addedEul.y, ((useRAWData == true ? fTInput.RawX : -fTInput.Yaw) / 500f) * rotationScale, rotationLerpRate * Time.deltaTime),
